...
export const userTable = connection.query(
  "CREATE TABLE IF NOT EXISTS Users (UserId INTEGER UNSIGNED PRIMARY KEY AUTO_INCREMENT NOT NULL, Email VARCHAR(50) NOT NULL UNIQUE, Username VARCHAR(30) NOT NULL UNIQUE, Phone VARCHAR(15) NOT NULL, Password VARCHAR(255) NOT NULL, Level TINYINT NOT NULL DEFAULT 1, Status  ENUM('a','i') NOT NULL DEFAULT 'a', CreatedAt TIMESTAMP NOT NULL, UpdatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP())",
