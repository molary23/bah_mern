...
export default function Contact() {
  ...
  const [inputs, setInputs] = useState<RegularObject>({}),
    ...
    nameCheck = useInputValidate(inputs, "name"),
    emailCheck = useInputValidate(inputs, "email"),
    phoneCheck = useInputValidate(inputs, "phone") || isNaN(inputs.phone),
    subjectCheck = useInputValidate(inputs, "subject"),
    messageCheck = useInputValidate(inputs, "message"),
