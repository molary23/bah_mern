...
export default function ParallaxArticle(props: SectionProp) {
  return (
    ...
    >
      <article className="h-max py-8 lg:h-[40rem] bg-blue-900/[0.6] lg:py-20 lg:px-20 flex flex-col sm-flex-row gap-y-8">
        <aside
          className={`${
            props?.type === "single" ? "bg-yellow-600" : ""
          } h-max lg:py-12 lg:px-6 lg:basis-1/2 hidden__element left__article`}
        >
