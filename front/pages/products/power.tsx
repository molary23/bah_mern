...
export default function power(props: RegularObject) {
...
`,
          ...
          <RightArticle
            ...
            imageSrc={`${SITE_URL}inverters.jpg`}
            imageAlt="Inverters"
          />
          <LeftArticle
            ...
            imageSrc={`${SITE_URL}bulb.jpg`}
            imageAlt="Energy Saving Bulbs"
          />
