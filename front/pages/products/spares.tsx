  ...
  return (
    <section>
      ...
      <ParallaxArticle
        ...
        description={[
          `All forklifts need tires to operate, but the types of tires and layout of tires on the forklift can vary significantly. Forklifts that use four tires are capable of lifting heavy loads and are versatile for many applications. Three-wheel forklifts are ideal for indoor environments where space is limited and the ability to turn and maneuver efficiently is important. There are two main types of forklift tires: Cushion Tires – Generally used for forklifts operating indoors, where surfaces are flat, smooth and consistent. Pneumatic/ Solid Tires – Pneumatic/ solid tire forklifts are generally used for operating outdoors, where surfaces can be uneven, rough or variable.
`,
        ]}
        imageSrc={sunset}
        type="dual"
