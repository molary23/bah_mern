...
export default function About() {
  return (
    <section>
      ...
      />
      <div className="my-4">
        <div className="about__content__all lg:w-5/6 h-fit py-12 px-4 lg:px-6 mx-auto">
          <div className="about__content__who bg-stone-100 h-fit my-6 p-6">
            ...
            <div className="about__content__who--details mt-6">
              ...
              <p className="about__content--para text-xl lg:text-2xl text-justify mb-3">
                The company was incorporated in 1990 as an enterprise in Lagos
                and later moved to Kano in the year 1996 to oversee the sales
                and services of automotive product. BEC ran a skeletal business
                in Eket, Akwa Ibom within 1999 to 2002 and later moved to Lagos.
              </p>
              <p className="about__content--para text-xl lg:text-2xl text-justify mb-3">
                The management underwent special trainings on warehouse
                equipment’s such as stocking on racks & forklifts services. It
                was during this period the company found out that most clients
                buy wrong equipment’s for use on the stock racking system and
                the company decided to normalize this for future clients that
                pass through us.
              </p>
              <p className="about__content--para text-xl lg:text-2xl text-justify mb-3">
                ...
                around by a team of experts and some well-qualified
                professionals from various part of the country.
              </p>
              <p className="about__content--para text-xl lg:text-2xl text-justify mb-3">
              ...
              <p className="about__content--para--m text-xl text-justify mb-3">
                BEC has the capacity of turning around the trust contracted to
                it by any of it client BEC has its Corporate Registered Office
                at 45, Makinde Street, Ojuelegba, Surulere, Lagos state and now
                moved to Ogun State: 2, Akinremi Adekunle Crescent, By Km51,
                Lagos Abeokuta Expressway, Abule Oke, Ifo LGA. We have branches
                links in Kano, Port-Harcourt and Eket and we are planning to
                have more link nationwide.
              </p>
              <p className="about__content--para--m text-xl text-justify mb-3">
          ...
          <div className="about__content__how h-fit my-6 p-6">
            <h2 className="text-center font-bold text-3xl lg:text-6xl page__subheading">
          ...
          <div className="about__content__obj h-fit my-6 p-6 bg-offBlue">
            <h2 className="text-center font-bold text-3xl lg:text-6xl page__subheading">
            ...
            <div className="about__content__obj--details mt-6">
              <ul className="list-disc list-outside ml-6">
                <li className="about__content--list text-xl lg:text-2xl">
                  To make all of our products and services market leaders in
                  their core categories in terms of quality and price
                  peculiarity while exceeding customer expectations.
                </li>
                <li className="about__content--list text-xl lg:text-2xl">
                ...
                <li className="about__content--list text-xl lg:text-2xl">
                  ...
                  work, satisfying work conditions and opportunities for
                  personal development, advancement and performance-based
                  remunerations.
                </li>
              </ul>
            </div>
          ...
          <div className="about__team flex flex-wrap  mx-auto justify-between border border-gray-100 rounded-md h-full py-10 px-6 lg:h-72 lg:py-14 lg:px-12 mt-4 ">
